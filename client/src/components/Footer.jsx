    ...
    <footer className="site-footer">
      <div className="footer-container">
        ...
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links">
              ...
              <li>
                <a href="mailto:rohitpal98222@gmail.com">
                  Help & Contact Us
                </a>
              </li>
              <li>
        ...
        <div className="footer-social-row">
          ...
          <a
            href="https://www.linkedin.com/in/rohit-pal02"
            target="_blank"
            rel="noopener noreferrer"
            className="footer-social-btn"
            aria-label="LinkedIn Profile"
            title="LinkedIn: www.linkedin.com/in/rohit-pal02"
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a
            href="https://t.me/Dinorohit"
            target="_blank"
            rel="noopener noreferrer"
            className="footer-social-btn"
            aria-label="Telegram Profile"
            title="Telegram: https://t.me/Dinorohit"
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a
            href="mailto:rohitpal98222@gmail.com"
            className="footer-social-btn"
            aria-label="Email Rohit Pal"
            title="Email: rohitpal98222@gmail.com"
          >
